...
# 1. 启动YOLO检测（自动等完成）
echo -e "\n[1/3] 启动YOLO检测..."
ros2 run yolo_counting_pkg yolo_detector --ros-args -p config_path:=/home/rose/pi4b_ros2/car_ws/src/yolo_counting_pkg/config/params.yaml
...
# 3. 启动小车控制（自动等优先级文件）
echo -e "\n[3/3] 启动小车执行动作..."
ros2 run test_control_pkg car_controller --ros-args -p serial_port:=/dev/ttyACM0
